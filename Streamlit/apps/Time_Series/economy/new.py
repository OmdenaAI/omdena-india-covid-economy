...
from apps.Time_Series.economy.oil import oil
...
def sensex(split):
    ...
    sensex = pd.read_csv('apps/Time_Series/economy/BSE_sensex.csv', sep=', ')
...
def nifty(split):
    ...
    nifty = pd.read_csv('apps/Time_Series/economy/Nifty.csv')
